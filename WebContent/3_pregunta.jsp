...
<body style="overflow: hidden; display: hidden;">
	<%
		...
		String val2 = request.getParameter("elem2");
	%>
	...
	<%
		...
		String sql = "select * from CalificacionBase where Califi_estado='2'";
		String sql_pregunta = "select * from Califi_preguntas where Califi_estado ='1' and Califi_numero_pregunta='3' order by Califi_numero_pregunta";
	...
	<table class="table_css">
		...
		<input id="val2" type="hidden" value="<%=val2%>">
