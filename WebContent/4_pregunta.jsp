...
<body style="overflow: hidden; display: hidden;">
	<%
		...
		String val3 = request.getParameter("elem3");
	%>
	...
	<%
		...
		String sql_pregunta = "select * from Califi_preguntas where Califi_estado ='1' and Califi_numero_pregunta='4' order by Califi_numero_pregunta";
	...
	<table class="table_css">
		...
		<input id="val3" type="hidden" value="<%=val3%>">
